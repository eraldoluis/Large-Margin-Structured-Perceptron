...
public class RankTemplate implements FeatureTemplate {
	 ...
	 * @param features
	 */
	public RankTemplate(int index, int[] features) {
		this.index = index;
	 ...
	 * @return
	 */
	public Feature getInstance(RankInput input, int item) {
	 ...
	 * @return
	 */
	public Feature newInstance(RankInput input, int item) {
		int[] basicFeatures = input.getBasicFeatures(item);
		if (basicFeatures == null)
			return null;
	...
	public Feature getInstance(ExampleInput input, Object... params) {
		return getInstance((RankInput) input, (Integer) params[0]);
	}

	@Override
	public Feature newInstance(ExampleInput input, Object... params) {
		return newInstance((RankInput) input, (Integer) params[0]);
	}
