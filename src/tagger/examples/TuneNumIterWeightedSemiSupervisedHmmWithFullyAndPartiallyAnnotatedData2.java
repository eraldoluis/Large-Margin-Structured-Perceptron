 ...
 * 
 */
public class TuneNumIterWeightedSemiSupervisedHmmWithFullyAndPartiallyAnnotatedData2 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(String.format(
				"Parameters:\n"
						...
						+ "	State feature: %s\n" + "\tModel file: %s\n"
						+ "	# iterations: %d\n" + "\tSeed: %d\n",
				trainFileNameS, trainFileNameSS, testFileName, weightS,
		...
		HmmTrainer wHmmTrainer = new HmmTrainer();
//		wHmmTrainer.setWeights(weights);
		...
		modelSupervised.save("model.conll2.txt");
		...
		ssHmmTrainer.setTuningSet(testset);
