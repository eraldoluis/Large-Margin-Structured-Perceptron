 ...
 * 
 */
public class DirectedMaxBranchAlgorithm implements MaximumBranchingAlgorithm {
	/**
	 * Logging object.
	 */
	private final static Log LOG = LogFactory
			.getLog(DirectedMaxBranchAlgorithm.class);
	 ...
	 */
	public DirectedMaxBranchAlgorithm(int maxNumberOfNodes) {
	...
	public double findMaxBranching(int numberOfNodes, double[][] graph,
		...
		if (checkUniqueRoot && !onlyPositiveEdges
				&& doneRootComponents.size() > 1)
	...
	public static void main(String[] args) {
		...
		DirectedMaxBranchAlgorithm eds = new DirectedMaxBranchAlgorithm(4);
